    ...
    <div class="max-w-md w-full">
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden">
            <div class="bg-gradient-to-r from-indigo-600 to-purple-600 px-6 py-8 text-center">
                <h2 class="text-4xl text-white font-bold">Connexion</h2>
                <p class="text-indigo-100 mt-2">Accéder à votre espace personnel</p>
            </div>
            <form class="p-6 space-y-6" action="/login" method="post">
                ...
                <div class="text-center pt-4 border-t border-gray-200">
                    <p class="text-sm text-gray-600">Pas encore de compte ? <a class="font-semibold text-indigo-600 
                    hower:text-indigo-700 transition-colors" href="/register">S'inscrire</p>
                </div>
            </form>
        </div>
    </div>
